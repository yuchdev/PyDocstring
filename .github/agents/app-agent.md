---
name: PyDocstring GitHub Coding Agent
description: GitHub-specific behaviour rules for AI-assisted changes in this repository.
---

<!-- COMMON-GUIDELINES -->

# Agentic Guidelines (Project-Wide)
...
The following files are **AI-PROTECTED** and must **NEVER** be edited by Copilot or any other AI tool:
